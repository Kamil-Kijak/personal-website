...
export default function AboutMe() {
    return (
        <main className="bg-zinc-900 min-h-screen pt-20 px-15">
            <section className="mt-40 pt-5 mx-8 shadow-xl shadow-red-700 rounded-2xl">
                <section className="flex flex-row md:justify-start justify-center">
                    <span className="text-6xl h-[5rem] md:ml-8 ml-0 self-center text-transparent bg-gradient-to-r from-red-700 to-orange-700 bg-clip-text font-extrabold ">My origin</span>
                </section>
                <section className="mt-10 p-5 border-t-4 border-red-700
            ...
            <section className="mt-40 pt-5 mx-8 shadow-xl shadow-purple-500 rounded-2xl">
                <section className="flex flex-row md:justify-start justify-center">
                    <span className="text-6xl h-[5rem] md:ml-8 ml-0 self-center text-transparent bg-gradient-to-r from-purple-500 to-fuchsia-700 bg-clip-text font-extrabold ">Character</span>
                </section>
                <section className="mt-10 p-5 border-t-4 border-purple-500
                 rounded-2xl flex flex-col md:flex-row justify-between items-center">
            ...
            <section className="mt-40 pt-5 mx-8 shadow-xl shadow-cyan-500 rounded-2xl">
                <section className="flex flex-row md:justify-start justify-center">
                    <span className="text-6xl h-[5rem] md:ml-8 ml-0 self-center text-transparent bg-gradient-to-r from-cyan-500 to-blue-700 bg-clip-text font-extrabold ">Why IT?</span>
                </section>
                <section className="mt-10 p-5 border-t-4 border-cyan-500
                 rounded-2xl flex flex-col md:flex-row justify-between items-center">
            ...
            <section className="mt-40 pt-5 mx-8 shadow-xl shadow-orange-500 rounded-2xl">
                <section className="flex flex-row md:justify-start justify-center">
                    <span className="text-6xl h-[5rem] md:ml-8 ml-0 self-center text-transparent bg-gradient-to-r from-orange-700 to-yellow-700 bg-clip-text font-extrabold ">My hobbies</span>
                </section>
                <section className="mt-10 p-5 border-t-4 border-orange-500
                 rounded-2xl flex flex-col md:flex-row justify-between items-center">
            ...
            <section className="mt-40 pt-5 mx-8 shadow-xl shadow-yellow-500 rounded-2xl">
                <section className="flex flex-row md:justify-start justify-center">
                    <span className="text-6xl h-[5rem] md:ml-8 ml-0 self-center text-transparent bg-gradient-to-r from-yellow-500 to-amber-500 bg-clip-text font-extrabold ">My future</span>
                </section>
                <section className="mt-10 p-5 border-t-4 border-yellow-500
                 rounded-2xl flex flex-col md:flex-row justify-between items-center">
