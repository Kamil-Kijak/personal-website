    ...
    return (
        <main className="bg-zinc-900 min-h-screen pb-[100px] pt-20">
            <section className="grid md:grid-cols-2 grid-cols-1 gap-10">
                <section className="shadow-2xl shadow-orange-400 m-10 flex justify-center items-center flex-col rounded-2xl pb-5 bg-gradient-to-t from-zinc-800 to-black">
                ...
                <section className="shadow-2xl shadow-white m-10 flex justify-center items-center flex-col rounded-2xl pb-5 bg-gradient-to-t from-zinc-800 to-black">
                ...
                <section className="shadow-2xl shadow-blue-500 m-10 flex justify-center items-center flex-col rounded-2xl pb-5 bg-gradient-to-t from-zinc-800 to-black">
                ...
                <section className="shadow-2xl shadow-fuchsia-700 m-10 flex justify-center items-center flex-col rounded-2xl pb-5 bg-gradient-to-t from-zinc-800 to-black">
                ...
                <section className="shadow-2xl shadow-rose-800 m-10 flex justify-center items-center flex-col rounded-2xl pb-5 bg-gradient-to-t from-zinc-800 to-black">
                ...
                <section className="shadow-2xl shadow-red-700 m-10 flex justify-center items-center flex-col rounded-2xl pb-5 bg-gradient-to-t from-zinc-800 to-black">
