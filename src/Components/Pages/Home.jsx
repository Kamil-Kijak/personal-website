    ...
    return(
        <main className="bg-zinc-900 min-h-screen pb-[100px]">
            ...
            <section className="flex flex-col justify-center items-center overflow-x-hidden">
                <section className="flex flex-col items-center mt-20 shadow-2xl shadow-cyan-500 lg:mx-20 mx-10 rounded-2xl py-8">
                ...
                <section className="flex flex-col items-center mt-50 shadow-2xl shadow-green-500 lg:mx-20 mx-10 rounded-2xl py-8">
                ...
                <section className="flex flex-col items-center mt-50 shadow-2xl shadow-red-500 lg:mx-20 mx-10 rounded-2xl py-8">
                ...
                <section className="flex flex-col items-center mt-50 shadow-2xl shadow-yellow-500 lg:mx-20 mx-10 rounded-2xl py-8 mb-20">
