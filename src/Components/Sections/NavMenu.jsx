...
export default function NavMenu({onHideSidebar}) {
    ...
    return (
        <>
            ...
            <section ref={screenShadow} onClick={hideSideBar} className="z-5 fixed top-0 bottom-0 left-0 right-0 opacity-0 bg-black duration-500 ease-out transition-all">
